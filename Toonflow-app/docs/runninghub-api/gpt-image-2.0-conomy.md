...
https://www.runninghub.ai/zh-cn/call-api/api-detail/2046503667076751361
...
| `imageUrls` | List(String) | 必填 | 最多支持 10 项图片，每张 50 MB |
| `aspectRatio` | String | 可选 | 枚举值: [1:1, 2:3, 3:2, 4:5, 5:4, 4:3, 3:4, 16:9, 9:16, 21:9, 9:21, 2:1, 1:2, 3:1, 1:3] |
| `resolution` | String | 可选 | 可选择 1k/2k/4k，因接口稳定性限制，暂不保证精准输出 2k/4k 分辨率，多数情况下仍会输出 1k 图像，介意请使用官方接口。<br>枚举值: [1k, 2k, 4k] |
