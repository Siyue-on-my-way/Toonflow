...
https://www.runninghub.ai/zh-cn/call-api/api-detail/2012004604507910146
...
```curl
curl --location --request POST 'https://www.runninghub.ai/openapi/v2/kling-video-o1/image-to-video' \
...
| --- | --- | --- | --- |
| `prompt` | String | 可选 | 文本长度限制: 5 - 2000 |
| `aspectRatio` | String | 必填 | 枚举值: [1:1, 9:16, 16:9] |
| `duration` | String | 必填 | 枚举值: [5, 10] |
| `firstImageUrl` | String | 必填 | 最多支持 1 项图片，每张 20 MB |
| `mode` | String | 必填 | 枚举值: [std, pro] |
