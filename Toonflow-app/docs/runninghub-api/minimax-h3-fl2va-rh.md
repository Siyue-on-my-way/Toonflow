接口:
/rhart-video/minimax-h3-oss/fl2va
https://www.runninghub.ai/zh-cn/call-api/api-detail/2088245432691560450

MiniMax H3 fl2va RH
基于开源 MiniMax H3 底座与 fl2va 插件流构建的全能视频生成接口。默认输出标准 768P 高清画质，单端点无缝整合文本生成、单图生成及首尾帧引导生成能力，智能适配输入模态，提供开箱即用且平滑连贯的视频生成体验。
全模态支持
首尾帧控制
默认768P输出
智能开箱即用
...
```curl
curl --location --request POST 'https://www.runninghub.ai/openapi/v2/rhart-video/minimax-h3-oss/fl2va' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
  "firstFrameUrl": null,
  "lastFrameUrl": null,
  "prompt": "蓝色头发动漫小美女鞭打派大星，无人受伤",
...
| --- | --- | --- | --- |
| `firstFrameUrl` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `lastFrameUrl` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
