...
https://www.runninghub.ai/zh-cn/call-api/api-detail/2133000000000504043
...
```curl
curl --location --request POST 'https://www.runninghub.ai/openapi/v2/rhart-video/sparkvideo-2.0-mini/multimodal-video' \
