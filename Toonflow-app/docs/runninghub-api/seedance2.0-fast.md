...
https://www.runninghub.ai/zh-cn/call-api/api-detail/2034917373414539278
...
```curl
curl --location --request POST 'https://www.runninghub.ai/openapi/v2/rhart-video/sparkvideo-2.0-fast/multimodal-video' \
