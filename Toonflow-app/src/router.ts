// @routes-hash e4acc43af49f9aa056a3795b08169ed3
...
import route176 from "./routes/assets/importFromLibrary";
import route177 from "./routes/library/folders";
import route178 from "./routes/library/folders/[id]";
import route179 from "./routes/library/libraryAssets";
import route180 from "./routes/library/libraryAssets/[id]";
import route181 from "./routes/assets/importFromProject";
...
import route50 from "./routes/oss/getFile";
import route51 from "./routes/oss/uploadFile";
...
import generationTasksRoute from "./routes/production/storyboard/generationTasks";
...
import route108 from "./routes/register/register";
...
import route156 from "./routes/setting/vendorConfig/addVendorModelSpec";
import route157 from "./routes/setting/vendorConfig/deleteVendor";
import route158 from "./routes/setting/vendorConfig/deleteVendorModelSpec";
...
import route169 from "./routes/setting/vendorConfig/updateVendorModelSpec";
...
import route200 from "./routes/quickVideo/getAssetBoard";
import route201 from "./routes/quickVideo/bindShotFirstFrame";
...
export default async (app: Express) => {
  ...
  app.use("/api/oss/getFile", route50);
  app.use("/api/oss/uploadFile", route51);
  ...
  app.use("/api/production/storyboard/generationTasks", generationTasksRoute);
  ...
  app.use("/api/register/register", route108);
  ...
  app.use("/api/setting/vendorConfig/addVendorModelSpec", route156);
  app.use("/api/setting/vendorConfig/deleteVendor", route157);
  app.use("/api/setting/vendorConfig/deleteVendorModelSpec", route158);
  ...
  app.use("/api/setting/vendorConfig/updateVendorModelSpec", route169);
  ...
  app.use("/api/assets/importFromLibrary", route176);
  app.use("/api/assets/importFromProject", route181);
  app.use("/api/library/folders", route177);
  ...
  app.use("/api/quickVideo/getAssetBoard", route200);
  app.use("/api/quickVideo/bindShotFirstFrame", route201);
}
