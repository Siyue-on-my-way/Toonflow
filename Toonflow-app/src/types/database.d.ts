// @db-hash deeb49beb7e45bf1b8785714aa414f5b
//该文件由脚本自动生成，请勿手动修改
...
export interface o_vendorAccount {
  'enable'?: number | null;
...
export interface skill_manual_image {
  'createTime'?: number | null;
  'id': string;
  'ossKey': string;
  'styleName': string;
...
export interface DB {
  ...
  "o_tasks": o_tasks;
  "o_user": o_user;
  "o_vendorAccount": o_vendorAccount;
  "o_vendorConfig": o_vendorConfig;
  "o_video": o_video;
  "o_videoTrack": o_videoTrack;
  "skill_manual": skill_manual;
  "skill_manual_image": skill_manual_image;
}
