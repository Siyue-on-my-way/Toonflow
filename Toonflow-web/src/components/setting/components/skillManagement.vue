  ...
  <div class="skillManagement">
    ...
    <section class="viewPanel">
      ...
      <div v-if="activeEntry" class="previewWrap">
        <MdPreview :theme="themeSetting.mode === 'dark' ? 'dark' : 'light'" :modelValue="content" :toolbars="[]" preview-only preview-theme="github" code-theme="atom" />
      </div>
    ...
    <t-dialog
      ...
      :on-confirm="onSave"
      :loading="isSaving">
      <MdEditor :theme="themeSetting.mode === 'dark' ? 'dark' : 'light'" v-model="draft" :toolbars="mdToolbars" preview-theme="github" code-theme="atom" style="height: 72vh" />
    </t-dialog>
  </div>
</template>
