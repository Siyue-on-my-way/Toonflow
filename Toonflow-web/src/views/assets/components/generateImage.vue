      ...
      <div class="data f">
        <t-card :bordered="false" :style="{ width: '40%' }">
          <div class="rawPicturePrompt">
            ...
            <div class="f ac" style="gap: 6px; margin-top: 8px">
              <span>{{ $t("components.modelSelect.type.text") }}</span>
              <modelSelect v-model="textModel" type="text" size="small" />
            </div>
            <div class="input">
          ...
          <div class="selectModel">
            ...
            <modelSelect v-model="selectValue" :type="`image`" :changeConfig="true" @change="handleModelChange" style="width: 100%" />
            <imageGenParams
              v-model:ratio="aspectRatio"
...
//生成参数（比例/分辨率/参考图由 imageGenParams 组件托管，选项随所选模型变化）
...
async function handleGenerate() {
  ...
  try {
    await axios.post("/assetsGenerate/generateAssets", {
      ...
      base64List: referenceImages.value,
