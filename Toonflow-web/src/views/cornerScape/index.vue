  ...
  <div class="cornerScape f">
    <div class="left">
      <t-card shadow class="card">
        ...
        <t-form labelAlign="top">
          ...
          <t-form-item :label="$t('components.modelSelect.type.text')">
    ...
    <div class="content">
      ...
      <t-empty v-if="dataList.length === 0" type="empty" :title="$t('workbench.cornerScape.operateScriptFirst')">
        <template #action>
          <t-button theme="primary" @click="goToScriptManagement">
            {{ $t("workbench.cornerScape.goToScriptManagement") }}
          </t-button>
        </template>
      </t-empty>
