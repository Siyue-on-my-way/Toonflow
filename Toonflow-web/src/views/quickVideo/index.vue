...
import type { QuickVideoDuration, QuickVideoRatio, QuickVideoStage, QuickVideoShot } from "@/types/quickVideo";
...
const { stopGenerate, getWorkbench, updateConfig, getMediaUrls, getTimeline } = quickVideoStoreRef;
