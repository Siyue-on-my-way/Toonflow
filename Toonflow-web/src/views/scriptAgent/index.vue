        ...
        <div class="box pr">
          ...
          <t-chat-sender
            ...
            <template #footer-prefix>
              <div class="chatFooterControls">
                <div class="chatFooterActions">
                ...
                <div class="agentModelSelect">
                  <span class="agentModelSelectLabel">{{ $t("components.modelSelect.type.text") }}</span>
...
const { connected, messages, status, planData, thinkLevel, textModel } = storeToRefs(scriptAgentStore());
